...
beautiful.titlebar_close_button_normal = "/usr/share/awesome/themes/theme/titlebar/close_normal_adapta.png"
beautiful.titlebar_close_button_focus = "/usr/share/awesome/themes/theme/titlebar/close_focus_adapta.png"
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Control"}, "Escape", function () awful.spawn("/usr/bin/rofi -show drun -show-icons -modi drun") end,
